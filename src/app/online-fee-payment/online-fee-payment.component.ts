...
@Component({
  selector: 'app-online-fee-payment',
  templateUrl: './online-fee-payment.component.html',
  styleUrls: ['./online-fee-payment.component.scss'],
  providers: [],
})

export class OnlineFeePaymentComponent implements OnInit {
