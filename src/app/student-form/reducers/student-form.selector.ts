...
import * as studentManagementReducer from './../reducers/student-form.reducer';

// *************************** PUBLIC API's ****************************
/**
 * Signup store functions
 */
export const studentManagementState = (state: AppState) => state.studentform;
...
export const editStudent = createSelector(studentManagementState, studentManagementReducer.editStudent);

export const prestudentAdded = createSelector(studentManagementState, studentManagementReducer.prestudentAdded);
export const preaddStudentLoading = createSelector(studentManagementState, studentManagementReducer.preaddStudentLoading);
export const preaddStudentLoaded = createSelector(studentManagementState, studentManagementReducer.preaddStudentLoaded);
export const preaddStudentFailed = createSelector(studentManagementState, studentManagementReducer.preaddStudentFailed);
